...
var initializeChat = function initializeChat(username) {
  // Make connection
  var socket = socket_io_client__WEBPACK_IMPORTED_MODULE_0___default.a.connect("https://lifechat-back.herokuapp.com"); // Query DOM
  ...
  welcome.innerHTML = "Witaj ".concat(username, ", po\u0142\u0105czy\u0142e\u015B si\u0119 z naszym konsultantem"); // Emit events
  ...
  message.addEventListener("keypress", function (e) {
    socket.emit("typing", username); //allows to send messages by pressing enter and prevents from sending empty messages
  ...
  socket.on("chat", function (data) {
    ...
    if (data.handle === username) {
      nickName = "<strong style=\"color:#eb6d21\">".concat(data.handle, ": </strong>");
    } else {
      nickName = "<strong>".concat(data.handle, ": </strong>");
    }
